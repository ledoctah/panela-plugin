...
public class RegisterUserService {
    ...
    public void execute(String name, String password) throws SQLException, IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        PreparedStatement preparedStatement = connection.prepareStatement("SELECT id FROM users_login WHERE name = ?");
        ...
        String hashedPassword = hashProvider.generateHash(password);

        preparedStatement = connection.prepareStatement("INSERT INTO users_login (name, password) VALUES (?, ?)");
